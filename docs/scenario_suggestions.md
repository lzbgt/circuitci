...
- When reviewed
  ...
  any declared reviewed input-deck setup evidence, and any declared reviewed
  solver sample/corner evidence, it emits runnable
  ...
  explicit solver-result, input-deck, and sweep evidence.
