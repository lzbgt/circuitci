...
Cursor A scrub control, cursor-sampled value/time readouts, and direct Scopes
trace-open actions for loaded schematic targets.
...
browser with Cursor A scrubbing plus cursor-sampled value/time readouts; those
chips and tints mark loaded waveform trace targets and are not schematic
components, pins, or nets.
...
- Sketch: shows a visual Board IR graph with selectable component/net nodes,
  ...
  loaded-trace jump browser, Cursor A scrub control, and cursor-sampled
  value/time rows,
