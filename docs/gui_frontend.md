...
source-filtered across cursor/trigger/region observations; Copy CSV and Export
CSV operate on the currently visible filtered rows and include those labels and
