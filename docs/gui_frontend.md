...
row-level report bundle export/index-open, source-specific snapshot clearing for sample and frequency rows,
...
value/time readouts, and row-level report bundle export/index-open; those chips and tints mark loaded waveform trace targets
