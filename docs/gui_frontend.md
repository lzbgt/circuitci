...
- Project: choose a Board IR project and output directory by typing paths or
  ...
  load-switch fixture, TLV803 reset-supervisor fixture, loop-stability Bode
  fixture, DC divider-bias fixture, divider-noise fixture, and RC Monte Carlo
  yield fixture; all
  ...
  and TLV803 reset fixtures, also show `Create Checks` to append a generated
  run setup with model-aware probes and observation checks for the placed
  component.
