...
- Simulation/Scopes: presents a runtime-first oscilloscope workspace linked
  ...
  selected-plus-pinned A/B cursor readouts, and transient measurement snapshots from cursor regions or trigger events with interactive plot marker chips plus row-level Jump and schematic Focus actions.
