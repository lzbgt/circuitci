...
compare pin/unpin/clear, and Open Compare actions for loaded schematic targets.
...
- Sketch: shows a visual Board IR graph with selectable component/net nodes,
  ...
  trace compare pin/unpin/clear actions, Open Compare jumps, hoverable/clickable `scope` activity chips, hover
