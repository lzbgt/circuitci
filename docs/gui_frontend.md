...
AHT20 I2C sensor fixture opens a generated-SPICE VDD and idle SDA/SCL pull-up
observation resolved from the source-backed model pack. The
...
- Project: choose a Board IR project and output directory by typing paths or
  ...
  TPD2EUSB30 USB ESD, PRTR5V0U2X USB ESD, ESD2CAN24-Q1 CAN ESD, TCAN3413 CAN transceiver, DRV8323 gate driver, PCA9685 PWM driver, ICM-42688-P IMU, BME280 I2C sensor, SHT31-DIS I2C sensor, AHT20 I2C sensor, W25Q64JV SPI flash, NAU7802 bridge ADC, ESDS552 RS-485 ESD, THVD1450 RS-485 transceiver, AP2112K LDO, AMS1117 LDO, TPS54331 buck, TPS62162 buck, TPS63802 buck-boost, TPS61023 boost, TPS2121 power mux, TPS2115A power mux,
