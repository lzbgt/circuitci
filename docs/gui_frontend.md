...
FT232R, CH347, CMSIS-DAP SWD, and ESP32-S3-WROOM boot/USB fixtures for
generated-SPICE rail, reset/strap, USB, and output-state observations. The
...
- Project: choose a Board IR project and output directory by typing paths or
  ...
  debug bridge fixture, CMSIS-DAP SWD probe fixture, ESP32-S3-WROOM boot/USB
  fixture, TXS0108E level-shifter
  ...
  FT232R USB-UART, CH347 USB-JTAG, CMSIS-DAP SWD, ESP32-S3-WROOM boot/USB,
