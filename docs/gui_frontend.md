...
manager. `Clean Old Bundles` only removes older direct child directories named
`scope_report_bundle_*` under the configured output directory, preserving the
newest bounded set and unrelated output folders.
