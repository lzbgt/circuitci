...
source/load-dependent gain limits. The RF Network Check editor can also write
...
MAG/MSG/unilateral-gain/source-load-gain, metric, aggregation, relation,
threshold, and source/load reflection fields.
