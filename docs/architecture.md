...
compact frequency/period readouts, bounded per-trace sparklines, live activity-snapshot status, visible-list snapshot capture, source-specific snapshot clearing, source-filtered Open Snapshots routing, compare pin/unpin/clear/named-save/load/delete actions, Open Compare jumps,
