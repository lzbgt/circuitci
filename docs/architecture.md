...
bounded per-trace sparklines, live activity-snapshot status, source-filtered Open Snapshots routing, compare pin/unpin/clear/named-save/load/delete actions, Open Compare jumps,
