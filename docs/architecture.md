...
| `BoardYamlRepairReport` | `repair_yaml` | Agent-facing patch-and-rerun proof for supported Board IR YAML repairs, currently `INVALID_POWER_DOMAIN` net-kind correction and `NET_NOT_FOUND` net creation on a copied project. |
