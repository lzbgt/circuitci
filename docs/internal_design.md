...
on-canvas selected-group quick toolbar, and quick actions; it must reuse
existing viewport, group-action, clipboard, duplication, and delete paths
instead of creating another mutation model.
