...
the repair copy uses the shared generated-SPICE model resolver, adds only
missing package fields, and validates the migrated copy without editing the
original project in place.
