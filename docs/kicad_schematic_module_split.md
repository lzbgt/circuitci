...
- `src/importers/kicad_sch/sexp.rs`: generic S-expression tokenization and
  list access helpers.
- `src/importers/kicad_sch/symbols.rs`: library symbol pin geometry, multi-unit
  symbol selection, hidden power pins, symbol rotation/mirroring, and schematic
...
multi-unit symbols, and hidden power pins.
