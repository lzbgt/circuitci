...
`vendor.onsemi.pnp_2n3906` is a source-backed PNP general-purpose transistor
...
`docs/research/datasheets/onsemi/2n3906.pdf`. Source notes and hashes are
recorded in `docs/research/datasheets/onsemi/2n3906_sources.md`.
