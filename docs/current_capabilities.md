...
| KiCad PCB | Placement, footprint drawing plus pin-1/body/courtyard semantic summaries, pad, board-outline, route, via, zone, and net-rule evidence for selected validations. | Compact layout evidence, not full fabrication DRC, BOM/PNP orientation proof, enclosure analysis, or field solving. |
