...
| Model quality | `LOW_CONFIDENCE_MODEL` report limitations, blocking `MODEL_QUALITY_REQUIRED` sign-off gates, and fail-closed OpenVAF/OSDI model compiler provenance checks for compiled Verilog-A compact-model artifacts. |
