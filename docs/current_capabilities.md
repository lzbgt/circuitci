...
| JLC/EasyEDA assembly | BOM/CPL import with JSON source/row/component manifest, EasyEDA Pro envelope inspection with Markdown plus JSON table/payload/object-hash manifest, flying-probe pad/net evidence. | Assembly evidence does not imply schematic intent or electrical pin behavior by itself; opaque EasyEDA Pro history payloads block geometry conversion. |
