...
- `CONTROLLED_IMPEDANCE_SOLVER_RESULT_VALID` compares explicit reviewed
  ...
  execution environment lock evidence, solver run-log reproducibility evidence, copper-roughness consistency,
  ...
  parse tool configuration locks, runtime allowlists, solver entitlement, environment, or
  run-log artifacts, or input decks, parse material libraries,
