...
- `CONTROLLED_IMPEDANCE_SOLVER_RESULT_VALID` compares explicit reviewed
  ...
  material-library artifact-content and material-corner consistency, fabricator stackup signoff,
  ...
  parse material libraries beyond reviewed manifest metadata, run a field solver, infer stackup parameters,
