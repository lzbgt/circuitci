...
This model is not a SPICE regulator macromodel. It is not valid for minimum
load regulation, output capacitor ESR/material stability sign-off, thermal
derating, load-transient behavior, short-circuit foldback, startup waveform, or
detailed load-dependent dropout sign-off.
