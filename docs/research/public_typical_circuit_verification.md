...
`suites/public_typical_circuits.yaml` combines twenty public-reference passing
cases and twenty-six paired injected-error cases:
...
```text
CircuitCI suite public_typical_circuits: pass (cases=46, passed=46, failed=0)
```
