...
- Local original:
  `docs/research/datasheets/onsemi/ss8050.pdf`
- SHA-256:
  `50d1896f9ea662a42c176077b3e87b81a0b561f128b8642bdc6804d3fafb1188`

Facts retained in `vendor.onsemi.ss8050`:

- The datasheet covers the SS8050 NPN epitaxial silicon transistor.
...
- It lists `VCE(sat) = 0.5 V` maximum at `IC = 800 mA`, `IB = 80 mA`, and
  `TC = 25 C`.
- It lists DC current gain from 120 to 400 at `VCE = 1 V`, `IC = 100 mA`, and
  `TC = 25 C`.
- It lists `Cob = 9 pF` typical at `VCB = 10 V`, `IE = 0`, `f = 1 MHz`.
