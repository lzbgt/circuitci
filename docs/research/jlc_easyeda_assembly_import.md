...
generic paste preset. The real `urine_monitor` imported release currently
generates no BGA stencil suggestion because the owner-backed solder-paste
evidence does not prove a repeated two-axis BGA grid for one component.
