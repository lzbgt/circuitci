use crate::board_ir::{BoardProject, ControlEffect, Endpoint, PinLogicState, PinMode, Scenario};
use crate::library::{
        ...
        for check in &scenario.checks {
            ...
            match check.as_str() {
                    ...
                    if scenario.scenario_type == "control_line_sequence" =>
                {
                    ...
                    validate_control_line_release(bound, scenario, &mut findings)
                }
                GPIO_BACKDRIVE
...
fn validate_control_line_release(
    bound: &BoundBoard<'_>,
    scenario: &Scenario,
...
fn component_pin_connected(bound: &BoundBoard<'_>, endpoint: &Endpoint) -> bool {
    bound
        .project
        .board
        .components
