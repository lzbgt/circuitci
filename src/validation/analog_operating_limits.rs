...
use crate::library::{BoundBoard, ComponentModel, SoaPoint, SpiceModelType};
...
use super::analog_soa::{invalid_soa_metadata_finding, validated_soa_curves};
...
pub(super) fn transient_duration_us(time_s: &[f64]) -> f64 {
...
pub(super) fn duration_above_limit_us(time_s: &[f64], values: &[f64], limit: f64) -> f64 {
