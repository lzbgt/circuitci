...
use super::analog_runner::{
    ModelSectionOverride, ParameterOverride, normalized_frequency_sweep_type_upper,
    rewrite_include_line, sweep_temperature_c,
};
...
pub(super) fn build_xyce_ac_wrapper(
    ...
    let sweep_type = normalized_frequency_sweep_type_upper(analog.analysis.sweep_type.as_deref())?;
    let mut text = String::new();
...
pub(super) fn build_xyce_noise_wrapper(
    ...
    let sweep_type = normalized_frequency_sweep_type_upper(analog.analysis.sweep_type.as_deref())?;
    text.push_str(&format!(
        ".NOISE {output_expr} {input_source} {sweep_type} {points} {start_hz:.12e} {stop_hz:.12e}\n"
    ));
