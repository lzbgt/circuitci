use crate::board_ir::{NetKind, PinLogicState, PlacementSide, Scenario};
use crate::library::{
...
pub(super) fn validate_bus_protection_placement(
    ...
    bus_placement::validate_bus_protection_placement(bound, scenario, findings);
}
...
pub(super) fn validate_usb_connector_orientation(
    ...
    usb_connector::validate_usb_connector_orientation(bound, scenario, findings);
}
...
pub(super) fn validate_usb_connector_protection(
    ...
    usb_connector::validate_usb_connector_protection(bound, scenario, findings);
}
...
pub(super) fn validate_usb_protection_placement(
    ...
    usb_connector::validate_usb_protection_placement(bound, scenario, findings);
}
...
pub(super) fn scenario_numeric_parameter(
    scenario: &Scenario,
    name: &str,
    findings: &mut Vec<Finding>,
) -> Option<f64> {
...
pub(super) fn required_scenario_numeric_parameter(
    scenario: &Scenario,
    name: &str,
    findings: &mut Vec<Finding>,
) -> Option<f64> {
...
pub(super) fn scenario_bool_parameter(scenario: &Scenario, name: &str) -> Option<bool> {
    scenario
        .parameters
        .get(name)
