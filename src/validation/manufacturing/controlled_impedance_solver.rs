...
use super::controlled_impedance_solver_metadata::{
    ...
    solver_entitlement_metadata_is_valid, solver_execution_environment_metadata_is_valid,
...
use super::controlled_impedance_solver_run_log::solver_run_log_metadata_is_valid;
...
fn solver_result_has_valid_metadata(
    ...
    if !solver_runtime_allowlist_metadata_is_valid(bound, scenario, findings, result) {
        return false;
    }
    if !solver_entitlement_metadata_is_valid(bound, scenario, findings, result) {
        return false;
    }
