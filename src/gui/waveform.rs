...
fn waveform_probe_group(probe: &WaveformProbe) -> WaveformProbeGroup {
    ...
    match probe
        .promoted_quantity
        .or_else(|| waveform_probe_quantity_from_label(&probe.label))
    {
...
fn waveform_probe_choices(waveform: &WaveformView, query: &str) -> Vec<WaveformProbeChoice> {
    waveform
        .probes
        .iter()
        .enumerate()
...
fn waveform_probe_group_choices(
