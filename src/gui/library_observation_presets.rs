...
use super::library_observation_preset_kinds::{
    ...
    add_level_shifter_observation_assertions, add_logic_buffer_observation_assertions,
...
#[derive(Debug, Clone)]
pub(super) struct ObservationProbeSpec {
...
fn observation_default_assertions(
    ...
    add_logic_buffer_observation_assertions(
        project,
        component,
        model,
        probes,
    ...
    add_mcu_observation_assertions(
        project,
        component,
        model,
        probes,
...
pub(super) fn probe_for_component_pin<'a>(
...
pub(super) fn voltage_for_component_pin(
    project: &crate::board_ir::BoardProject,
    component: &crate::board_ir::ComponentSpec,
    pin: &str,
) -> Option<f64> {
...
pub(super) fn component_parameter_f64(
    component: &crate::board_ir::ComponentSpec,
    parameter: &str,
) -> Option<f64> {
    component
...
pub(super) fn default_voltage_assertion(
    scenario_name: &str,
    assertion_name: &str,
    probe_name: &str,
    aggregation: &str,
...
pub(super) fn default_sample_assertion(
    scenario_name: &str,
    assertion_name: &str,
    probe_name: &str,
    relation: &str,
