...
fn gui_project_example_registry_lists_scope_and_observation_fixtures() {
    const EXPECTED: &[ExpectedProjectExample] = &[
        ...
        ExpectedProjectExample {
            ...
            project_path: "examples/good_nordic_nrf52840_board_observation/project.yaml",
            project_name: "good_nordic_nrf52840_board_observation",
            expected_traces: &[
                "v_vdd",
                "v_vddh",
                "v_vbus",
            ...
            expected_frequency: "3.3 V nRF52840 with VDD/VDDH, 5 V VBUS, released reset, SWD, UART, USB, and antenna idle states",
