    ...
    fn scope_side_dock(&mut self, ui: &mut egui::Ui) {
        egui::ScrollArea::vertical().show(ui, |ui| {
            ...
            if let Some(snapshot) = self.project_snapshot.clone() {
                ...
                self.dc_sweep_assertion_editor(ui);
        ...
        if self.report.is_some() {
            ...
            egui::CollapsingHeader::new("Artifacts")
                ...
                .show(ui, |ui| {
                    ...
                    ui.add_space(8.0);
                    self.dc_sweep_assertion_failure_actions(ui, &report.failures);
                    ui.add_space(8.0);
                    ...
                    ui.add_space(8.0);
                    self.transfer_function_assertion_failure_actions(ui, &report.failures);
                    ui.add_space(8.0);
