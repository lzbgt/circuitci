...
use validation::validate_applied_fields;
...
pub(super) struct AppliedControlledImpedanceSolverResult {
    ...
    solver_output_schema: Option<String>,
    solver_output_schema_version: Option<String>,
    solver_output_schema_uri: Option<String>,
    solver_output_schema_sha256: Option<String>,
    solver_config_lock_uri: Option<String>,
    solver_config_lock_sha256: Option<String>,
    solver_config_lock_tool: Option<String>,
    solver_config_lock_revision: Option<String>,
...
#[derive(Debug, Clone)]
pub(super) struct AppliedControlledImpedanceSolverMaterialLibrary {
    pub(super) name: String,
    source: String,
    material_library: String,
    material_library_revision: String,
...
#[derive(Debug, Clone)]
pub(super) struct AppliedControlledImpedanceSolverRuntimeAllowlist {
    pub(super) name: String,
    source: String,
    solver: String,
    solver_config_lock_revision: String,
...
#[derive(Debug, Clone)]
pub(super) struct AppliedControlledImpedanceSolverExecutionEnvironment {
    pub(super) name: String,
    source: String,
    solver: String,
    solver_version: String,
...
pub(super) struct AppliedControlledImpedanceSolverRunLog {
    ...
    precision_policy_source: Option<String>,
    precision_policy_artifact_uri: Option<String>,
    precision_policy_artifact_sha256: Option<String>,
    floating_point_precision: Option<String>,
    min_significant_digits: Option<usize>,
    max_roundoff_error_ohm: Option<f64>,
...
fn applied_field(
    ...
    if field == ManufacturingField::ControlledImpedanceSolverMaterialLibrary {
        applied.controlled_impedance_solver_material_library = Some(
            applied_controlled_impedance_solver_material_library(row, path)?,
        );
        return Ok(applied);
    }
    ...
    if field == ManufacturingField::ControlledImpedanceSolverRuntimeAllowlist {
        applied.controlled_impedance_solver_runtime_allowlist = Some(
            applied_controlled_impedance_solver_runtime_allowlist(row, path)?,
        );
        return Ok(applied);
    }
    ...
    if field == ManufacturingField::ControlledImpedanceSolverExecutionEnvironment {
        applied.controlled_impedance_solver_execution_environment = Some(
            applied_controlled_impedance_solver_execution_environment(row, path)?,
        );
        return Ok(applied);
    }
...
fn applied_controlled_impedance_solver_material_library(
    row: &MetadataCsvRow,
    path: &Path,
...
fn applied_controlled_impedance_solver_runtime_allowlist(
    row: &MetadataCsvRow,
    path: &Path,
...
fn applied_controlled_impedance_solver_execution_environment(
    row: &MetadataCsvRow,
    path: &Path,
