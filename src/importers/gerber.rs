...
fn merge_solder_mask_into_project(project_yaml: &mut Value, mask: &GerberCopper) -> Result<()> {
    merge_layer_artwork_into_project(project_yaml, "solder_mask", "solder mask", mask)
}

fn merge_solder_paste_into_project(project_yaml: &mut Value, paste: &GerberCopper) -> Result<()> {
...
fn summary_for_solder_mask(mask: &GerberCopper) -> GerberSolderMaskImportSummary {
...
fn summary_for_solder_paste(paste: &GerberCopper) -> GerberSolderPasteImportSummary {
