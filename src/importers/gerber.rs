use crate::board_ir::{BoardLayout, BoardProject, CopperZone, LayoutPad, LayoutPoint, NetRoute};
...
fn associate_copper_nets(copper: &mut GerberCopper, layout: &BoardLayout) {
