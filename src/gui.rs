...
mod library;
mod library_observation_preset_kinds;
...
pub struct CircuitCiApp {
    ...
    analog_dc_sweep_source: String,
    analog_dc_sweep_start: f64,
    analog_dc_sweep_stop: f64,
    analog_dc_sweep_step: f64,
    ...
    analog_distortion_mode: String,
    analog_distortion_f1_source: String,
    analog_distortion_f2_source: String,
    analog_distortion_f2_over_f1: f64,
    analog_measure_mode: String,
    analog_measure_template_name: String,
    analog_measure_operation: String,
    analog_measure_from: f64,
    ...
    analog_sweep_monte_carlo_distribution: String,
    analog_sweep_model_path: String,
    analog_sweep_model_sections: String,
    analog_sweep_min_yield_percent: String,
    analog_sweep_min_p1_margin: String,
    analog_sweep_min_p5_margin: String,
    analog_sweep_min_p50_margin: String,
    analog_sweep_min_p95_margin: String,
