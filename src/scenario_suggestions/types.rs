...
pub struct SuggestedUsbConnector {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub entry_clearance: Option<SuggestedUsbEntryClearance>,
}
...
pub struct SuggestedFootprint {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub entry_clearance: Option<SuggestedFootprintEntryClearance>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Serialize)]
pub struct SuggestedFootprintEntryClearance {
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct SuggestedBoardEdge {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub connector_body_overhang_mm: Option<f64>,
...
#[derive(Debug, Serialize)]
pub struct SuggestedUsbEntryObstruction {
    pub component: String,
    pub obstruction_depth_mm: f64,
    pub obstruction_lateral_offset_mm: f64,
    pub obstruction_reference: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub obstruction_footprint_graphic_layer: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub obstruction_footprint_graphic_kind: Option<String>,
}
...
pub struct SuggestedRegulator {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub switch_inductor_net_a: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub switch_inductor_pin_b: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub switch_inductor_net_b: Option<String>,
    #[serde(
        rename = "input_inductance_min_H",
        skip_serializing_if = "Option::is_none"
    )]
    pub input_inductance_min_h: Option<f64>,
    #[serde(
        rename = "input_inductance_max_H",
        skip_serializing_if = "Option::is_none"
    )]
    pub input_inductance_max_h: Option<f64>,
    #[serde(
        rename = "input_support_inductance_H",
        skip_serializing_if = "Option::is_none"
    )]
    pub input_support_inductance_h: Option<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub input_support_inductors: Option<Vec<String>>,
    #[serde(
    ...
    #[serde(
        rename = "switch_inductance_min_H",
        skip_serializing_if = "Option::is_none"
    )]
    pub switch_inductance_min_h: Option<f64>,
    #[serde(
        rename = "switch_inductance_max_H",
        skip_serializing_if = "Option::is_none"
    )]
    pub switch_inductance_max_h: Option<f64>,
    #[serde(
        rename = "switch_support_inductance_H",
        skip_serializing_if = "Option::is_none"
    )]
    pub switch_support_inductance_h: Option<f64>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub switch_support_inductors: Option<Vec<String>>,
}
