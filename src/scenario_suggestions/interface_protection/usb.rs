...
use crate::board_ir::{
    BoardProject, ComponentPlacement, ComponentSpec, LayoutFootprint, LayoutFootprintRectangle,
    LayoutFootprintSegment, LayoutPoint, LayoutSegment, NetKind, NetLayoutRule, NetRoute,
    RouteSegment,
};
