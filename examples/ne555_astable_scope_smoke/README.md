...
connected, readable circuit. The saved coordinates are generated by the Sketch
classical Auto Layout engine using source-seeded ranks, rails, KiCad pin
anchors, and orthogonal routes; electrical connectivity still comes from the
